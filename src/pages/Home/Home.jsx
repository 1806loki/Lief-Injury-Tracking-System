        ...
        <Row className="cardSection" justify="center" gutter={[16, 16]}>
          ...
          <Col xs={24} sm={20} md={18} lg={8} xl={6}>
            <Card title="Body Mapping">
              ...
              injury locations, providing valuable insights for proper care and
              analysis.
            </Card>
          </Col>
          <Col xs={24} sm={20} md={18} lg={8} xl={6}>
            <Card title="Data Security">
              Your data's safety is our priority. SafenjuryLogix employs robust
              security measures to protect sensitive information, giving you
              peace of mind.
            </Card>
          </Col>
        </Row>
        <Row justify="center" gutter={[16, 16]} style={{ paddingTop: "10px" }}>
          <Col xs={24} sm={20} md={18} lg={16} xl={14}>
            <Title level={3}>Get Started Today!</Title>
            <Paragraph>
              Join us in enhancing safety standards and simplifying injury
              reporting. Whether you're part of law enforcement, healthcare, or
              any safety-focused organization, InjuryLogix is tailored to your
              needs.
            </Paragraph>
          </Col>
        </Row>
